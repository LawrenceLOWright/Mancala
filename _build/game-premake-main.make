...
RESCOMP = windres
INCLUDES += -I../game -I../game/src -I../game/include -I../raylib/src -I../raylib/src/external -I../raylib/src/external/glfw/include
FORCE_INCLUDE +=
...
TARGET = $(TARGETDIR)/game-premake-main.exe
OBJDIR = obj/x64/Debug/game-premake-main
...
TARGETDIR = ../_bin/Debug
TARGET = $(TARGETDIR)/game-premake-main.exe
OBJDIR = obj/x86/Debug/game-premake-main
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGET = $(TARGETDIR)/game-premake-main.exe
OBJDIR = obj/x64/Release/game-premake-main
...
TARGETDIR = ../_bin/Release
TARGET = $(TARGETDIR)/game-premake-main.exe
OBJDIR = obj/x86/Release/game-premake-main
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
GENERATED += $(OBJDIR)/updateboard.o
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking game-premake-main
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning game-premake-main
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
...
$(OBJDIR)/screen_title.o: ../game/src/screen_title.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/updateboard.o: ../game/src/updateboard.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
